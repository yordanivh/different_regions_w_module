# different_regions_w_module
This repo will create two instances in different regions using modules

# What this repo does

This repo's code will create two AWS instances in two different regions at the same time. This is accomplished by using a module and a provider is defined each time the module is called.
